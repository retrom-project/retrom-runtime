...
- EasyRPG Player — GPL-3.0-or-later — <https://github.com/xxxsen/Player>
- liblcf — MIT — <https://github.com/EasyRPG/liblcf>
- mkxp-z — GPL-2.0-or-later — <https://github.com/xxxsen/mkxp-z-libretro-emscripten>
...
maintained forks and the fixed ONScripterYuri source commit are the corresponding source entry points. Applications redistributing a release remain
