...
describe("current Provider launch boundary", () => {
  ...
  it("uses one declaration for all seven RPG targets and non-RPG core capabilities", () => {
    ...
    expect(retromRuntimeProviderDefinition.adapters.map((entry) => entry.kind).sort()).toEqual([
      "APPLE2JS_WEB", "BUTTERSCOTCH_WEB", "EASYRPG_WEB", "FAKE08_WEB", "GBE_POKEMINI_WEB", "J2ME_MINIJVM_WEB", "JSBEEB_WEB", "KIRIKIRI2_WEB", "MKXP_LIBRETRO_WEB", "NATIVE_WEB", "NP2KAI_WEB", "NXENGINE_WEB", "ONS_YURI_WEB", "OPENBOR_WEB",
      "PLAY_WEB", "PPSSPP_WEB", "PX68K_WEB", "RUFFLE_WEB", "SAMCOUPE_WEB", "SCUMMVM_WEB", "TIC80_WEB", "TYRANOSCRIPT_WEB", "WASM4_WEB", "WEBMSX_WEB",
    ]);
