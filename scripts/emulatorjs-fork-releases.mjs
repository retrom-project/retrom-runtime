const identities = {
  ...
  dosbox_pure: {repository: "https://github.com/retrom-project/dosbox-pure", baseline: "g3a5222c97456",
    license: "LICENSE.md", source: "source.tar.gz", coreAsset: "dosbox_pure-thread-wasm.data",
    adapterAbi: "emulatorjs-content-io-v1", release: "4.3.0-pre"},
