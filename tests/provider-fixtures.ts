...
export function targetEnvelope(targetId: string): LaunchEnvelopeV1 {
  ...
  } else if (["bbc-jsbeeb", "gbe-pokemini", "j2me", "tic80", "fake08", "flash-ruffle", "msx-webmsx", "openbor", "px68k", "np2kai-pc98"].includes(targetId)) {
  ...
  const targetOptions: LaunchEnvelopeV1["targetOptions"] = targetId === "onscripter-yuri"
      ...
      : targetId === "kirikiri2-kag"
        ...
        : targetId === "scummvm"
          ...
          : {};
  return {
    resources: targetId === "bbc-jsbeeb" ? [resource, {
