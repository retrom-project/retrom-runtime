...
describe("retrom-runtime provider declarations", () => {
  it("declares the complete 0.27.0 target closure in one source", () => {
    expect(retromRuntimeProviderDefinition.providerVersion).toBe("0.27.0");
