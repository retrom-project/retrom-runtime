...
describe("retrom-runtime provider declarations", () => {
  it("declares the complete 0.24.0-rc.3 target closure in one source", () => {
    expect(retromRuntimeProviderDefinition.providerVersion).toBe("0.24.0-rc.3");
