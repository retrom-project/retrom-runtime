...
describe("retrom-runtime provider declarations", () => {
  it("declares the complete 0.19.0-rc.2 target closure in one source", () => {
    expect(retromRuntimeProviderDefinition.providerVersion).toBe("0.19.0-rc.2");
