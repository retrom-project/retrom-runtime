...
export const pspAdapter = defineAdapter({id: "ppsspp-web", kind: "PPSSPP_WEB", abi: "ppsspp-host-v1",
...
export const pspTarget = defineTarget({id: "ppsspp", displayName: "PPSSPP (PSP)", adapterId: pspAdapter.id,
  ...
  assetPaths: ["ppsspp.js", "ppsspp.wasm", "ppsspp.data", "ppsspp.worker.mjs", "ppsspp-host.mjs", "ppsspp-input.mjs", "ppsspp-audio.mjs"]
