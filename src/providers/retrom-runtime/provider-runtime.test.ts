...
describe("Provider-owned lifecycle", () => {
  ...
  it.each(["third-party error", "TYRANOSCRIPT_RUNTIME_TIMEOUT", "FANTASY_CORE_ABI_MISMATCH", "WEBMSX_START_TIMEOUT"])("fails once and cleans controls after %s", async (error) => {
