...
### Cave Story / NXEngine (development candidate)
...
The new source is an unpublished development input. Build it in the corresponding core PFB and import a verified candidate Provider base. It must be replaced by an authorized immutable core release input before formal Provider release. The product acceptance contract lives in Retrom's `ACC-NXENGINE-001`; game data is never packaged in this repository.
