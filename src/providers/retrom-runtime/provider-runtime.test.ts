...
describe("Provider-owned lifecycle", () => {
  ...
  it.each(["third-party error", "TYRANOSCRIPT_RUNTIME_TIMEOUT", "FANTASY_CORE_ABI_MISMATCH", "OPENBOR_CORE_LOAD_FAILED"])("fails once and cleans controls after %s", async (error) => {
